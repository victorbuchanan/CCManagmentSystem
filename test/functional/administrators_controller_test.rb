...
class AdministratorsControllerTest < ActionController::TestCase
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post :create, administrator: { adminPin: @administrator.adminPin, employeeNum: @administrator.employeeNum, userid: @administrator.userid }
    end
  ...
  test "should update administrator" do
    put :update, id: @administrator, administrator: { adminPin: @administrator.adminPin, employeeNum: @administrator.employeeNum, userid: @administrator.userid }
    assert_redirected_to administrator_path(assigns(:administrator))
  end
